...
class RegisterW extends StatefulWidget {
  final Function toggleView;
  RegisterW({this.toggleView});
  @override
  _RegisterWState createState() => _RegisterWState();
}

class _RegisterWState extends State<RegisterW> {
